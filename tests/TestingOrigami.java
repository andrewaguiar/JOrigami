...
public class TestingOrigami extends TestCase {

	private static final String oneLine = "teste com o componente origami  1123M0109201114591.723.569991COMPLEX";
	private static final String manyLines = "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n" + "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n"
			+ "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n" + "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n"
			+ "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n" + "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n"
			+ "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n" + "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n"
			+ "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n" + "#It cant be parsed. used to test failure tolerance levels\n"
			+ "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n" + "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n"
			+ "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n" + "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n"
			+ "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n" + "teste com o componente origami  1123M0109201114591.723.569991COMPLEX\n"
			+ "#It cant be parsed. used to test failure tolerance levels";
	...
	private BasicOrigami readFromOneLine() throws IOException, FileNotFoundException {
		...
		try {
			origami.mount(new ByteArrayInputStream(TestingOrigami.oneLine.getBytes()));
	...
	public void testOrigamiFaultTolerantWithFaultListener() throws Exception {
		...
		origami.mount(new ByteArrayInputStream(TestingOrigami.manyLines.getBytes()));
